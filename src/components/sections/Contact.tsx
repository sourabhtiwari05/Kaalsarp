      ...
      <div className="mx-auto w-full px-4 xs:px-5 sm:px-6 lg:px-8 xl:max-w-285">
        ...
        >
          ...
          <button
            ...
            className="w-full flex items-center justify-center gap-2 py-3.5 rounded-full bg-linear-to-br from-gold-soft via-gold to-gold-dark text-maroon-deep font-bold text-base shadow-cta hover:brightness-105 hover:-translate-y-0.5 transition-all focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-gold disabled:opacity-60 disabled:cursor-not-allowed"
          >
            {status === "submitting" ? (
              "भेज रहे हैं..."
            ) : (
              <>
                <svg
                  viewBox="0 0 24 24"
                  className="w-5 h-5 text-maroon-deep"
                  fill="currentColor"
                >
